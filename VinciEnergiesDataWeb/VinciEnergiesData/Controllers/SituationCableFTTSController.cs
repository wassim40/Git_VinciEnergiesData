...
{
    [Authorize]
    public class SituationCableFTTSController : Controller
    {

        private readonly ApplicationDbContext _db;
        private readonly string wwwrootDirectory = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/Files");

        public SituationCableFTTSController(ApplicationDbContext db)
        {
            _db = db;
        }
        ...
        public IActionResult CreateFile()
        {
            ...
            {
                if (i.dossier == Enums.GenreFolder.SC_FTTS.ToString())
                {
                    files.Add(i.nom);
                }
            }
